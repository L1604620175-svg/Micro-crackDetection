...
quantize.py是量化脚本，尝试了两种策略的量化，但实践证明，YOLOv8s本身就是轻量化模型，在边缘设备上FP32已达最优，无需量化。<img width="643" height="221" alt="屏幕截图 2026-07-14 161602" src="https://github.com/user-attachments/assets/8a0ac59e-7040-475c-ba0e-8c1521a8e2e1" />
prune.py是剪枝脚本，尝试了两种剪枝策略。![Uploading 屏幕截图 2026-07-14 164910.png…]()
