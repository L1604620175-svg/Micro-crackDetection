...
def main():
    ...
    print("-" * 52)
    print(f"{'FP32 原始':<12} {size_fp32:>10.1f} {results_fp32.box.map50:>8.4f} {results_fp32.box.mr:>8.4f} {ms_fp32_b:>8.1f}ms")
    print(f"{'FP16 ONNX':<12} {size_fp16:>10.1f} {results_fp16.box.map50:>8.4f} {results_fp16.box.mr:>8.4f} {ms_fp16_b:>8.1f}ms")
    print(f"{'INT8 动态':<12} {size_int8:>10.1f} {results_int8.box.map50:>8.4f} {results_int8.box.mr:>8.4f} {ms_int8_b:>8.1f}ms")
